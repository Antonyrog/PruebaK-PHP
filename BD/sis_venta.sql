...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 26-04-2023 a las 16:39:14
...
(1, 'Frutas', '2023-04-26 10:56:46'),
(3, 'Gasesosa', '2023-04-26 11:37:02');
...
(1, 123456789, 'Kafeteria Konecta', 'Konecta', 3232323, 'KafeK@Konecta.com', 'Colombia', '0.19');
...
(1, 8, '2023-04-26 08:01:18', 20, '2000.00', 1);
...
(1, 'Postobon', 'Manzana', 3, '2000.00', 10, 67, '2023-04-26 09:00:11', 1),
(2, 'Manzana', 'Apple', 1, '3000.00', 25, 200, '2023-04-26 09:01:11', 1);
...
--
ALTER TABLE `detallefactura`
  MODIFY `correlativo` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
